...
#This map is not rendering due to an unsolved issue with input type.
tm_sample_clusters <- gee_example %>%
  tm_shape(state %>%
             filter(STATEFP == '06'  | STATEFP == '04' | STATEFP == '32')) +
    tm_fill("gray98") +
  tm_shape(gee_example) +
  tm_polygons(col = char("cluster_class"),
